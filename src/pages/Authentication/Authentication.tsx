  ...
  return (
    <Container>
      ...
      <Group position="center" my={30}>
        <Button
          color="indigo"
          variant={authMode === AUTHENTICATION_MODE.LOGIN ? 'filled' : 'outline'}
        ...
        <Button
          color="indigo"
          variant={authMode === AUTHENTICATION_MODE.REGISTER ? 'filled' : 'outline'}
          onClick={() => handleSetAuthMode(AUTHENTICATION_MODE.REGISTER)}
        >
          Register
        </Button>
      </Group>
      {authMode === AUTHENTICATION_MODE.LOGIN ? <LoginForm /> : <RegisterForm />}
    </Container>
  )
}
